  ...
  return (
    <main className="min-h-screen">
      ...
      <div className="fixed inset-0 -z-10 overflow-hidden">
        <div className="absolute -top-[10%] -right-[10%] h-[500px] w-[500px] rounded-full bg-purple-200 dark:bg-purple-900/20 blur-[120px]" />
        <div className="absolute top-[40%] -left-[5%] h-[300px] w-[300px] rounded-full bg-blue-200 dark:bg-blue-900/20 blur-[120px]" />
        <div className="absolute -bottom-[10%] right-[20%] h-[400px] w-[400px] rounded-full bg-pink-200 dark:bg-pink-900/20 blur-[120px]" />
      </div>

      {/* Navigation */}
      <nav className="fixed top-0 z-50 w-full backdrop-blur-lg border-b border-slate-100 dark:border-slate-800">
      ...
      <AnimatedSection className="flex min-h-screen flex-col items-center justify-center py-20 md:py-32">
        <div className="container px-4 grid md:grid-cols-2 gap-12 items-center">
          <div className="order-2 md:order-1">
            ...
            <h2 className="mb-6 text-3xl font-bold">Frontend Engineer</h2>
          ...
          <div className="order-1 md:order-2 perspective-1000">
            <div className="relative h-60 w-60 md:h-80 md:w-80 mx-auto rotate-6 transform rounded-2xl bg-gradient-to-br from-purple-500 to-blue-500 p-1 shadow-xl transition-all duration-500 hover:rotate-12 hover:scale-105">
              <Image
                src={Rabin}
                alt="Profile"
                width={500}
...
For the past 1–1.5 years, I’ve been crafting sleek, responsive web apps full-time 💻✨ and constantly learning new tricks to level up my UI game.
      ...
      <AnimatedSection id="projects" className="py-20 md:py-32">
       <ProjectCarousel></ProjectCarousel></AnimatedSection>
  ...
  <ProjectCard
    title="Lubro Paints"
    description="A complete website for Lubro Paints with user-facing pages, admin dashboard, and full content management system."
  ...
  <ProjectCard
    ...
    description="A full-featured school management system for Premier College with admin panels, dynamic content, and multi-role access built using modern tech stacks."
    tags={["React.js", "Tailwind CSS", "FastAPI", "Django","mySQL"]}
    imageUrl={pre} // Reusing an image until you have a third one
    showGithub={false}
    demoText="Launching Soon..."
  ...
  />
      ...
      {/* Experience Section */}
      <AnimatedSection id="experience" className="py-20 md:py-32 bg-muted/50">
        <div className="container px-4">
          <h2 className="mb-12 text-center text-3xl font-bold md:text-4xl">
            Work{" "}
            <span className="bg-gradient-to-r from-purple-500 to-blue-500 bg-clip-text text-transparent">
